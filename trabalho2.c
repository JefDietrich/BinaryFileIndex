...
int main()
{
    ...
    CHAVE_PRIMARIA chavePrimaria[7];
    fread(chavePrimaria, sizeof(CHAVE_PRIMARIA), 7, arquivo);
...
int popularDadosIndice(FILE *resultado, BUSCA_INDICE dadosIndice[])
{
    ...
    {
        posicaoRegistro = ftell(resultado) - sizeof(int);

        LOCACAO_VEICULO veiculoAInserir;
        contadorDeCaninho = 0;
        i = 0, letrasPercorridas = 0;
